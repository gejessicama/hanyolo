...
def show(filename="goodData/Horizontal_heating_steady_state.csv"):
    ...
    plt.scatter(time, Temp[:, 4:5], c="m", marker="o", label="5", s=size)
    ...
    plt.scatter(time, Temp[:, 3:4], c="r", marker="o", label="4", s=size)
    ...
    plt.scatter(time, Temp[:, 2:3], c="c", marker="o", label="3", s=size)
    ...
    plt.scatter(time, Temp[:, 0:1], c="b", marker="o", label="1", s=size)
